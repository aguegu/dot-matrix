...
DrvTb62726X74hc138::DrvTb62726X74hc138(DotMatrix & dm, uint8_t pin_din, uint8_t pin_clk, uint8_t pin_latch, uint8_t pin_en, uint8_t pin_rext,
...
DrvTb62726X74hc138::~DrvTb62726X74hc138()
{

}

void DrvTb62726X74hc138::setSpeed(uint16_t scan_span)
{
	_scan_span = scan_span;
}

void DrvTb62726X74hc138::setSize()
{
...
void DrvTb62726X74hc138::setBrightness(byte brg)
{
	chip_col.setBrightness(brg);
}

void DrvTb62726X74hc138::setCol(byte row) const
{
	byte * p = _dm.output();
	p += _byte_per_row * row;
...
void DrvTb62726X74hc138::display(byte times) const
{
	while (times--)
	{
