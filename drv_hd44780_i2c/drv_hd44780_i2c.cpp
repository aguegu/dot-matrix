...
void DrvHd44780I2c::clear() const // 0x01
{
	this->transmit(false, 0x01);
	delayMicroseconds(2000);
}

void DrvHd44780I2c::rst() const // 0x02
{
	this->transmit(false, 0x02);
	delayMicroseconds(2000);
}

void DrvHd44780I2c::configureInput(bool ac, bool screen_move) const // 0x04
{
	byte cmd = 0x04;
...
void DrvHd44780I2c::configureDisplay(bool display_on, bool cursor,
...
void DrvHd44780I2c::moveCursor(bool right) const // 0x10
{
	byte cmd = 0x10;
	if (right)
		cmd |= 0x04;
...
void DrvHd44780I2c::moveScreen(bool right) const // 0x11
{
	byte cmd = 0x11;
	if (right)
		cmd |= 0x04;
...
void DrvHd44780I2c::configureFunction(bool interface8, bool doubleline,
...
void DrvHd44780I2c::setCGRam(byte *pFont, byte length) const // 0x40
{
...
void DrvHd44780I2c::setCursor(byte address) const // 0x80
{
	this->transmit(false, address | 0x80);
}

////////////////////
void DrvHd44780I2c::putString(byte address, char *p, byte length) const
{
	char *pp = p;
...
void DrvHd44780I2c::putChar(byte address, char c) const
{
	this->putString(address, &c, 1);
}

void DrvHd44780I2c::init()
{
	this->initHardware();
...
void DrvHd44780I2c::putCache() const
{
...
void DrvHd44780I2c::printf(byte index, const char *__fmt, ...)
{
...
void DrvHd44780I2c::printf(const char *__fmt, ...)
{
	va_list ap;
	va_start(ap, __fmt);
...
void DrvHd44780I2c::setCache(byte value)
{
	memset(_cache, value, _cache_length);
}

void DrvHd44780I2c::setCache(byte index, byte value)
{
	if (index >= _cache_length)
		return;
