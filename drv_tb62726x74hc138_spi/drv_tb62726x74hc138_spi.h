...
#ifndef DRV_TB62726_X_74HC138_SPI_H_
...
class DrvTb62726X74hc138Spi
{
public:
	DrvTb62726X74hc138Spi(DotMatrix & dm, SPIClass & spi, uint8_t pin_latch,
			uint8_t pin_en, uint8_t pin_rext, uint8_t pin_a2, uint8_t pin_a1,
			uint8_t pin_a0, uint8_t pin_oe, uint16_t scan_speed = 0x600);

	virtual ~DrvTb62726X74hc138Spi();
...
#endif /* DRV_TB62726_X_74HC138_SPI_H_ */
