...
DrvTb62726X74hc138Spi::DrvTb62726X74hc138Spi(DotMatrix & dm, SPIClass & spi, uint8_t pin_latch, uint8_t pin_en, uint8_t pin_rext,
...
DrvTb62726X74hc138Spi::~DrvTb62726X74hc138Spi()
{

}

void DrvTb62726X74hc138Spi::setSpeed(uint16_t scan_span)
{
	_scan_span = scan_span;
}

void DrvTb62726X74hc138Spi::setSize()
{
...
void DrvTb62726X74hc138Spi::setBrightness(byte brg)
{
	chip_col.setBrightness(brg);
}

void DrvTb62726X74hc138Spi::setCol(byte row) const
{
	byte * p = _dm.output();
	p += _byte_per_row * row;
...
void DrvTb62726X74hc138Spi::display(byte times) const
{
	while (times--)
	{
