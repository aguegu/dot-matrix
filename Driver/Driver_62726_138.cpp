...
Driver_62726_138::Driver_62726_138(DotMatrix & dm, uint8_t pin_din, uint8_t pin_clk, uint8_t pin_latch, uint8_t pin_en, uint8_t pin_rext,
...
Driver_62726_138::~Driver_62726_138()
{

}

void Driver_62726_138::setSpeed(uint16_t scan_span)
{
	_scan_span = scan_span;
}

void Driver_62726_138::setSize()
{
...
void Driver_62726_138::setBrightness(byte brg)
{
	chip_col.setBrightness(brg);
}

void Driver_62726_138::setCol(byte row) const
{
	byte * p = _dm.output();
	p += _byte_per_row * row;
...
void Driver_62726_138::display(byte times) const
{
	while (times--)
	{
